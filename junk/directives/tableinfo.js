		...
		template: `<div class="table">
					<table class="table table-hover">
						...
						<tr ng-repeat="(i, val) in data">
							<td ng-repeat="(i, field) in datakeys.value" ng-if="field === 'shippingDate'"> <a ng-if="!val['shippingDate']" ng-click="cartHandler(val['_id'])" href="../store"> Start Shopping With This Order </a> <p ng-if="val['shippingDate']">{{val[field]}}</p> </td>
							<td ng-repeat="(i, field) in datakeys.value" ng-if="field !== 'picture' && field !== 'products' && field !== 'shippingDate' && field !== 'price"> {{val[field]}} </td>
